...
const config = {
  ...
  url: 'https://ast3risk-ops.github.io/blend-docs/',
  ...
  organizationName: 'ast3risk-ops', // Usually your GitHub org/user name.
  projectName: 'blend-docs', // Usually your repo name.
